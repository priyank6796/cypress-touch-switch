...
reg32 * CapSense_CSD_pcTable[] = {
    (reg32 *)CapSense_CSD_Sns__Button0__BTN__PC, 
    (reg32 *)CapSense_CSD_Sns__Button1__BTN__PC, 
    (reg32 *)CapSense_CSD_Sns__Button2__BTN__PC, 
    (reg32 *)CapSense_CSD_Sns__Button3__BTN__PC, 
    (reg32 *)CapSense_CSD_Sns__Button4__BTN__PC, 
};

const uint8 CapSense_CSD_portTable[] = {
    CapSense_CSD_Sns__Button0__BTN__PORT, 
    CapSense_CSD_Sns__Button1__BTN__PORT, 
    CapSense_CSD_Sns__Button2__BTN__PORT, 
    CapSense_CSD_Sns__Button3__BTN__PORT, 
    CapSense_CSD_Sns__Button4__BTN__PORT, 
};

const uint32 CapSense_CSD_maskTable[] = {
    CapSense_CSD_Sns__Button0__BTN__MASK, 
    CapSense_CSD_Sns__Button1__BTN__MASK, 
    CapSense_CSD_Sns__Button2__BTN__MASK, 
    CapSense_CSD_Sns__Button3__BTN__MASK, 
    CapSense_CSD_Sns__Button4__BTN__MASK, 
};

const uint8 CapSense_CSD_pinShiftTbl[] = {
    (uint8) CapSense_CSD_Sns__Button0__BTN__SHIFT, 
    (uint8) CapSense_CSD_Sns__Button1__BTN__SHIFT, 
    (uint8) CapSense_CSD_Sns__Button2__BTN__SHIFT, 
    (uint8) CapSense_CSD_Sns__Button3__BTN__SHIFT, 
    (uint8) CapSense_CSD_Sns__Button4__BTN__SHIFT, 
};
...
uint8 CapSense_CSD_senseClkDividerVal[CapSense_CSD_TOTAL_SCANSLOT_COUNT];
uint8 CapSense_CSD_sampleClkDividerVal[CapSense_CSD_TOTAL_SCANSLOT_COUNT];
